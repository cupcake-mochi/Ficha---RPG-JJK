...
PERTURBACOES = [
    ...
    ("multiplicador do corpo forte", ["trilhas", "Servo", "multiplicador_corpo"], 3.0,
     "corpo forte"),
    ...
    ("a régua volta a multiplicar alguma coisa", ["morte", "multiplicador_regua"], 4,
     "multiplicador 1"),
    ("quantos corpos a Matilha põe", ["trilhas", "Matilha", "corpos"], 4,
     "Matilha: 5 corpo"),
    # o rotulo "forte"/"cru" morreu com o corpo do Coro subindo para 2x: sao tres
    # multiplicadores possiveis, e o binario virou mentira. Perturbar o numero.
    ("o corpo do Coro alcança o corpo forte",
     ["trilhas", "Coro", "multiplicador_corpo"], 2.5, "MENOR que o corpo forte"),
